...
export const SEPOLIA_RPC: string = "https://sepolia.infura.io/v3/<API_KEY>";
export const W1_PRIV_KEY: string = process.env.W1_PRIV_KEY || '';
export const W2_PRIV_KEY: string = process.env.W2_PRIV_KEY || '';
export const PLACE_CONTRACT: string = "0x577e280f3c6df309823fec8f52ffbab94c2e31be"
export const CANCEL_CONTRACT: string = "0x82068c5f51c8a45d96014b82dfa95aa0fbfb6e55"
export const FILL_CONTRACT: string = "0x0f6c0bd5d8756e1a635b252f0cad87509d90f526"
